    ...
    <div className="flex justify-between w-full min-h-40 pb-2 pt-2">
      <div className="w-2/3">
        ...
        <h4 className="font-mono text-gray-500">
          {`Rs ` + price / 100 || defaultPrice / 100 || finalPrice / 100}
        </h4>
        <p>{description}</p>
      </div>
      <div className="w-1/3 flex flex-col gap-2 items-center">
        ...
        {from !== "cart" && (
          <button
            ...
            className="border border-gray-300 text-green-600 px-8 py-2 rounded-md font-bold font-sans text-lg hover:cursor-pointer hover:bg-gray-100"
          >
            ADD
          </button>
        )}
